...
public class PagerSlidingTab extends HorizontalScrollView {
    ...
    private int underlineColor = 0xb2bdbdbd;
    ...
    private int tabTextColor = getResources().getColor(R.color.xml_rank_tab_text_color);
    ...
    public PagerSlidingTab(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabTextColor = getResources().getColor(R.color.xml_rank_tab_text_color);
